                ...
                switch (name) {
                    ...
                    case "print_3mf":
                        ...
                        try {
                            ...
                            let parsedAmsMapping = undefined;
                            ...
                            if (args?.ams_mapping) {
                                let userMappingOverride = undefined;
                            ...
                            throw new Error(`Failed during 3MF processing: ${error.message}`);
                        }
                    ...
                    case "merge_vertices":
                        ...
                        result = await this.stlManipulator.mergeVertices(String(args.stl_path), args.tolerance !== undefined ? Number(args.tolerance) : undefined // Pass tolerance if provided
                        );
                        break;
                    case "center_model":
                        if (!args?.stl_path) {
